...
public class DecisionScopeTests {
    ...
    public void testConstructor_nullActivityId() {
        // test
        final DecisionScope scope =
                new DecisionScope(null, "xcore:offer-placement:1111111111111111");
        Assert.assertNotNull(scope);
        Assert.assertEquals("", scope.getName());
    }
    ...
    public void testConstructor_nullPlacementId() {
        // test
        final DecisionScope scope =
                new DecisionScope("xcore:offer-activity:1111111111111111", null);
        Assert.assertNotNull(scope);
        Assert.assertEquals("", scope.getName());
    }
    ...
    @Test
    public void testIsValid_scopeIsDecodableMboxString() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            base64MockedStatic
                    .when(
                            () ->
    ...
    @Test
    public void testIsValid_scopeIsValidNonDecodableMboxString() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            base64MockedStatic
                    .when(
                            () ->
    ...
    @Test
    public void testIsValid_scopeIsValidDecodableMboxJson() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            base64MockedStatic
                    .when(
                            () ->
                            ...
                            (Answer<byte[]>)
                                    invocation ->
                                            java.util.Base64.getDecoder()
                                                    .decode((String) invocation.getArguments()[0]));
            // test
            // represents "{"sampleKey":"sampleValue"}"
            final DecisionScope scope = new DecisionScope("eyJzYW1wbGVLZXkiOiJzYW1wbGVWYWx1ZSJ9");
            Assert.assertTrue(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithDefaultItemCount() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjExMTExMTExMTExMTExMTEiLCJ4ZG06cGxhY2VtZW50SWQiOiJ4Y29yZTpvZmZlci1wbGFjZW1lbnQ6MTExMTExMTExMTExMTExMSJ9");
            Assert.assertTrue(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithItemCount() {
        ...
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjExMTExMTExMTExMTExMTEiLCJ4ZG06cGxhY2VtZW50SWQiOiJ4Y29yZTpvZmZlci1wbGFjZW1lbnQ6MTExMTExMTExMTExMTExMSIsInhkbTppdGVtQ291bnQiOjEwMH0=");
            Assert.assertTrue(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithValidName() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            // test
            final DecisionScope scope =
                    new DecisionScope("eyJ4ZG06bmFtZSI6ImNvbS5hZG9iZS5TYW1wbGVBcHAifQ==");
            Assert.assertTrue(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithEmptyActivityId() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJ4ZG06YWN0aXZpdHlJZCI6IiIsInhkbTpwbGFjZW1lbnRJZCI6Inhjb3JlOm9mZmVyLXBsYWNlbWVudDoxMTExMTExMTExMTExMTExIn0=");
            Assert.assertFalse(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithEmptyPlacementId() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjExMTExMTExMTExMTExMTEiLCJ4ZG06cGxhY2VtZW50SWQiOiIifQ==");
            Assert.assertFalse(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithInvalidItemCount() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJhY3Rpdml0eUlkIjoieGNvcmU6b2ZmZXItYWN0aXZpdHk6MTExMTExMTExMTExMTExMSIsInBsYWNlbWVudElkIjoieGNvcmU6b2ZmZXItcGxhY2VtZW50OjExMTExMTExMTExMTExMTEiLCJpdGVtQ291bnQiOi0xfQ==");
            Assert.assertFalse(scope.isValid());
        }
    }
    ...
    public void testIsValid_encodedScopeWithZeroItemCount() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjExMTExMTExMTExMTExMTEiLCJ4ZG06cGxhY2VtZW50SWQiOiJ4Y29yZTpvZmZlci1wbGFjZW1lbnQ6MTExMTExMTExMTExMTExMSIsInhkbTppdGVtQ291bnQiOjB9");
            Assert.assertFalse(scope.isValid());
        }
    }

    @Test
    public void testIsValid_invalidJsonEncodedScope() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            base64MockedStatic
                    .when(
                            () ->
            ...
            final DecisionScope scope =
                    new DecisionScope(
                            "eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjExMTExMTExMTExMTExMTEiLCJ4ZG06cGxhY2VtZW50SWQiOiJ4Y29yZTpvZmZlci1wbGFjZW1lbnQ6MTExMTExMTExMTExMTExMSwieGRtOml0ZW1Db3VudCI6MzB9");
            Assert.assertTrue(scope.isValid());
        }
    }
                            ...
                            (Answer<byte[]>)
                                    invocation ->
                                            java.util.Base64.getDecoder()
                                                    .decode((String) invocation.getArguments()[0]));
            // test
            final DecisionScope scope1 =
                    new DecisionScope(
                            "eyJhY3Rpdml0eUlkIjoieGNvcmU6b2ZmZXItYWN0aXZpdHk6MTExMTExMTExMTExMTExMSIsInBsYWNlbWVudElkIjoieGNvcmU6b2ZmZXItcGxhY2VtZW50OjExMTExMTExMTExMTExMTEifQ==");
            final DecisionScope scope2 =
                    new DecisionScope(
                            "xcore:offer-activity:1111111111111111",
                            "xcore:offer-placement:1111111111111111");
    ...
    public void testEquals_decisionScopeObjectContainsItemCount() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            ...
            final DecisionScope scope1 =
                    new DecisionScope(
                            "eyJhY3Rpdml0eUlkIjoieGNvcmU6b2ZmZXItYWN0aXZpdHk6MTExMTExMTExMTExMTExMSIsInBsYWNlbWVudElkIjoieGNvcmU6b2ZmZXItcGxhY2VtZW50OjExMTExMTExMTExMTExMTEiLCJpdGVtQ291bnQiOjEwMH0=");
            final DecisionScope scope2 =
                    new DecisionScope(
                            "xcore:offer-activity:1111111111111111",
                            "xcore:offer-placement:1111111111111111",
    ...
    @Test
    public void testEquals_decisionScopeObjectsEqual() {
        try (MockedStatic<Base64> base64MockedStatic = Mockito.mockStatic(Base64.class)) {
            base64MockedStatic
                    .when(
                            () ->
    ...
    @Test
    public void testEquals_thisDecisionScopeObjectIsNull() {
        // test
        final DecisionScope scope1 = null;
        final DecisionScope scope2 = new DecisionScope("mymbox");
        Assert.assertNotEquals(scope1, scope2);
    }

    @Test
    public void testEquals_otherDecisionScopeObjectNamesIsNull() {
        // test
        final DecisionScope scope1 = new DecisionScope("mymbox");
    ...
    @Test
    public void testEquals_bothDecisionScopeObjectNamesAreNull() {
        // test
        final DecisionScope scope1 = new DecisionScope(null);
        final DecisionScope scope2 = new DecisionScope(null);
        Assert.assertEquals(scope1, scope2);
    }

    @Test
    public void testEquals_decisionScopeObjectsAreSame() {
        // test
        final DecisionScope scope = new DecisionScope("mymbox");
    ...
    @Test
    public void testEquals_thatDecisionScopeObjectIsASubclass() {
        // test
        final DecisionScope scope1 = new DecisionScope("mymbox");
        ;
        final DecisionScope scope2 = new DecisionScopeSubclass("mymbox");
        Assert.assertNotEquals(scope1, scope2);
    }
    ...
    static class DecisionScopeSubclass extends DecisionScope {

        public DecisionScopeSubclass(String name) {
            super(name);
        }
    }
}
